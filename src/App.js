    ...
    <>
      <div className="App">
        ...
        {flagCredentials ? (
          ...
          <>
            <Container className="d-flex flex-row w-100 h-100">
              <Container className=" w-50 h-100" fluid>
                <Row className="d-flex justify-content-center w-3 border mb-5"
                  xs="12"
                  lg="6"
                  md="6">
                  <Col className="w-100 d-flex justify-content-center">
                    <Button
                      onClick={() => setFlagCredentials(true)}
                    >
                      Edit Credentials
                    </Button>
                  </Col>
                ...
                <Row
                  className="d-flex mt-1 justify-content-center w-3 border"
                  xs="12"
                  lg="6"
                  md="6"
                >
                ...
                <Row
                  className="d-flex mt-3 justify-content-center border"
                  xs="12"
                  lg="6"
                  md="6"
                >
                ...
                <Row>
                  <div className="d-flex justify-content-around mt-2 border">
                    <Button
                      style={{ width: "120px" }}
              ...
              <div
                id="video-canvas"
                style={{ height: "auto", minWidth: "640px" }}
              ></div>
            </Container>
